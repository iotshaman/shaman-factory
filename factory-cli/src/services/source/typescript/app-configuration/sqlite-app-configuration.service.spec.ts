...
import { SqliteAppConfigurationService } from './sqlite-app-configuration.service';
...
describe('Mysql App Configuration Service', () => {
  ...
  it("getConfigName should return 'sqliteConfig'", () => {
    let subject = new SqliteAppConfigurationService();
    expect(subject.getConfigName()).to.equal("sqliteConfig");
  })
