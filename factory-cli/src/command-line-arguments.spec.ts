...
describe('Command Line Arguments', () => {
    ...
    it('getValueOrDefault should return provided value', () => {
        let subject = new CommandLineArguments(['test', 'test', 'command', '--key=value']);
        expect(subject.getValueOrDefault('key')).to.equal("value");
    });
    ...
    it("getDefault should return default environment", () => {
        let subject = new CommandLineArguments(['test', 'test', 'command']);
        expect(subject.getDefault("environment")).to.equal("*");
    })
