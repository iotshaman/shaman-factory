...
describe('Install Command', () => {
  ...
  it('run should return resolved promise for single environment install', (done) => {
    let subject = new InstallCommand();
    subject.environmentCommandFactory = sandbox.stub().returns(
...
class MockNodeInstallCommand implements IEnvironmentCommand {
...
class MockDotnetInstallCommand implements IEnvironmentCommand {
