    ...
    var e = /\blang(?:uage)?-(\w+)\b/i,
      ...
      a = (_self.Prism = {
            ...
            for (var i in e)
              e.hasOwnProperty(i) &&
                ...
                "Object" !== a.util.type(e[i]) || r[a.util.objId(e[i])]
                  ? "Array" !== a.util.type(e[i]) || r[a.util.objId(e[i])] || ((r[a.util.objId(e[i])] = !0), a.languages.DFS(e[i], t, i, r))
        ...
        highlightElement: function (t, n, r) {
          ...
          l && ((i = (l.className.match(e) || [, ""])[1]), (s = a.languages[i])),
      ...
      ((n.stringify = function (e, t, r) {
        ...
        if ("Array" === a.util.type(e))
          return e
            ...
            .join("");
        var i = { type: e.type, content: n.stringify(e.content, t, r), tag: "span", classes: ["token", e.type], attributes: {}, language: t, parent: r };
